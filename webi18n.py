...
_it = {
    ...
    "fwd.tokenHelp": "Il token te lo dà il sistema che riceve. In Vedetta: apri il tuo device, premi Genera sulla riga GrappaSafe e salva. Se stai modificando, lascia il campo vuoto per tenere quello di prima.",
    "fwd.none": "Nessun sistema configurato.",
    "fwd.add": "Aggiungi sistema",
    "fwd.on": "attivo",
    "fwd.off": "spento",
    "fwd.tokenSet": "token ••••{hint}",
    "fwd.noToken": "manca il token: l'inoltro non parte",
    "fwd.lastOk": "ultimo invio riuscito",
    "fwd.lastError": "errore: {msg}",
    "fwd.never": "mai inviato",
    "fwd.test": "Prova",
    "fwd.testing": "invio in corso…",
    "fwd.testOk": "collegamento riuscito",
    "fwd.testFail": "collegamento fallito: {msg}",
    "fwd.required": "Servono un nome e un indirizzo che inizi con https://",
    "fwd.saveError": "Non è stato possibile salvare.",
    "fwd.confirmDelete": "Smettere di inoltrare la posizione a questo sistema?",
...
_en = {
    ...
    "fwd.tokenLabel": "Token",
    "fwd.tokenHelp": "The receiving system gives you the token. In Vedetta: open your device, press Generate on the GrappaSafe row and save. When editing, leave this empty to keep the current one.",
    "fwd.none": "No system configured.",
    "fwd.add": "Add a system",
    "fwd.on": "on",
    "fwd.off": "off",
    "fwd.tokenSet": "token ••••{hint}",
    "fwd.noToken": "no token: nothing will be sent",
    "fwd.lastOk": "last delivery ok",
    "fwd.lastError": "error: {msg}",
    "fwd.never": "nothing sent yet",
    "fwd.test": "Test",
    "fwd.testing": "sending…",
    "fwd.testOk": "connection works",
    "fwd.testFail": "connection failed: {msg}",
    "fwd.required": "A name and an address starting with https:// are required",
    "fwd.saveError": "Could not save.",
    "fwd.confirmDelete": "Stop forwarding your position to this system?",
...
_de = {
    ...
    "fwd.tokenLabel": "Token",
    "fwd.tokenHelp": "Das Token bekommst du vom empfangenden System. In Vedetta: öffne dein Gerät, drücke in der GrappaSafe-Zeile auf Generieren und speichere. Beim Bearbeiten leer lassen, um das bisherige zu behalten.",
    "fwd.none": "Kein System konfiguriert.",
    "fwd.add": "System hinzufügen",
    "fwd.on": "aktiv",
    "fwd.off": "aus",
    "fwd.tokenSet": "Token ••••{hint}",
    "fwd.noToken": "kein Token: es wird nichts gesendet",
    "fwd.lastOk": "letzte Übertragung ok",
    "fwd.lastError": "Fehler: {msg}",
    "fwd.never": "noch nichts gesendet",
    "fwd.test": "Testen",
    "fwd.testing": "senden…",
    "fwd.testOk": "Verbindung funktioniert",
    "fwd.testFail": "Verbindung fehlgeschlagen: {msg}",
    "fwd.required": "Name und eine Adresse, die mit https:// beginnt, sind erforderlich",
    "fwd.saveError": "Speichern nicht möglich.",
    "fwd.confirmDelete": "Keine Position mehr an dieses System weiterleiten?",
...
_fr = {
    ...
    "fwd.tokenHelp": "Le jeton vous est fourni par le système destinataire. Dans Vedetta : ouvrez votre appareil, cliquez sur Générer sur la ligne GrappaSafe et enregistrez. En modification, laissez vide pour conserver le précédent.",
    "fwd.none": "Aucun système configuré.",
    "fwd.add": "Ajouter un système",
    "fwd.on": "actif",
    "fwd.off": "inactif",
    "fwd.tokenSet": "jeton ••••{hint}",
    "fwd.noToken": "jeton manquant : rien ne sera envoyé",
    "fwd.lastOk": "dernier envoi réussi",
    "fwd.lastError": "erreur : {msg}",
    "fwd.never": "rien envoyé pour l'instant",
    "fwd.test": "Tester",
    "fwd.testing": "envoi…",
    "fwd.testOk": "la connexion fonctionne",
    "fwd.testFail": "échec de la connexion : {msg}",
    "fwd.required": "Un nom et une adresse commençant par https:// sont nécessaires",
    "fwd.saveError": "Enregistrement impossible.",
    "fwd.confirmDelete": "Cesser de transférer votre position vers ce système ?",
...
_es = {
    ...
    "fwd.tokenLabel": "Token",
    "fwd.tokenHelp": "El token te lo da el sistema que recibe. En Vedetta: abre tu dispositivo, pulsa Generar en la fila GrappaSafe y guarda. Al editar, déjalo vacío para mantener el actual.",
    "fwd.none": "Ningún sistema configurado.",
    "fwd.add": "Añadir sistema",
    "fwd.on": "activo",
    "fwd.off": "apagado",
    "fwd.tokenSet": "token ••••{hint}",
    "fwd.noToken": "falta el token: no se enviará nada",
    "fwd.lastOk": "último envío correcto",
    "fwd.lastError": "error: {msg}",
    "fwd.never": "aún no se ha enviado nada",
    "fwd.test": "Probar",
    "fwd.testing": "enviando…",
    "fwd.testOk": "la conexión funciona",
    "fwd.testFail": "conexión fallida: {msg}",
    "fwd.required": "Hacen falta un nombre y una dirección que empiece por https://",
    "fwd.saveError": "No se ha podido guardar.",
    "fwd.confirmDelete": "¿Dejar de reenviar tu posición a este sistema?",
...
_nl = {
    ...
    "fwd.tokenLabel": "Token",
    "fwd.tokenHelp": "Het token krijg je van het ontvangende systeem. In Vedetta: open je apparaat, druk op Genereren in de GrappaSafe-regel en sla op. Laat bij het bewerken leeg om het huidige te behouden.",
    "fwd.none": "Geen systeem ingesteld.",
    "fwd.add": "Systeem toevoegen",
    "fwd.on": "aan",
    "fwd.off": "uit",
    "fwd.tokenSet": "token ••••{hint}",
    "fwd.noToken": "geen token: er wordt niets verstuurd",
    "fwd.lastOk": "laatste verzending gelukt",
    "fwd.lastError": "fout: {msg}",
    "fwd.never": "nog niets verzonden",
    "fwd.test": "Testen",
    "fwd.testing": "versturen…",
    "fwd.testOk": "verbinding werkt",
    "fwd.testFail": "verbinding mislukt: {msg}",
    "fwd.required": "Een naam en een adres dat met https:// begint zijn verplicht",
    "fwd.saveError": "Opslaan is niet gelukt.",
    "fwd.confirmDelete": "Stoppen met het doorsturen van je positie naar dit systeem?",
...
_pl = {
    ...
    "fwd.tokenLabel": "Token",
    "fwd.tokenHelp": "Token dostajesz od systemu odbierającego. W Vedetta: otwórz swoje urządzenie, naciśnij Generuj w wierszu GrappaSafe i zapisz. Przy edycji zostaw puste, aby zachować obecny.",
    "fwd.none": "Brak skonfigurowanych systemów.",
    "fwd.add": "Dodaj system",
    "fwd.on": "włączone",
    "fwd.off": "wyłączone",
    "fwd.tokenSet": "token ••••{hint}",
    "fwd.noToken": "brak tokena: nic nie zostanie wysłane",
    "fwd.lastOk": "ostatnia wysyłka udana",
    "fwd.lastError": "błąd: {msg}",
    "fwd.never": "nic jeszcze nie wysłano",
    "fwd.test": "Testuj",
    "fwd.testing": "wysyłanie…",
    "fwd.testOk": "połączenie działa",
    "fwd.testFail": "połączenie nieudane: {msg}",
    "fwd.required": "Wymagana jest nazwa i adres zaczynający się od https://",
    "fwd.saveError": "Nie udało się zapisać.",
    "fwd.confirmDelete": "Przestać przekazywać pozycję do tego systemu?",
...
_cs = {
    ...
    "fwd.tokenLabel": "Token",
    "fwd.tokenHelp": "Token vám dá přijímající systém. Ve Vedettě: otevřete své zařízení, na řádku GrappaSafe stiskněte Vygenerovat a uložte. Při úpravě nechte prázdné, aby zůstal stávající.",
    "fwd.none": "Není nastaven žádný systém.",
    "fwd.add": "Přidat systém",
    "fwd.on": "zapnuto",
    "fwd.off": "vypnuto",
    "fwd.tokenSet": "token ••••{hint}",
    "fwd.noToken": "chybí token: nic se neodešle",
    "fwd.lastOk": "poslední odeslání v pořádku",
    "fwd.lastError": "chyba: {msg}",
    "fwd.never": "zatím nic neodesláno",
    "fwd.test": "Otestovat",
    "fwd.testing": "odesílání…",
    "fwd.testOk": "spojení funguje",
    "fwd.testFail": "spojení selhalo: {msg}",
    "fwd.required": "Je potřeba název a adresa začínající na https://",
    "fwd.saveError": "Uložení se nezdařilo.",
    "fwd.confirmDelete": "Přestat přeposílat vaši polohu do tohoto systému?",
